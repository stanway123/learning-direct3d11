    ...
    XMVECTOR& boundingBoxMax)
{
    ...
    {        
        ...
        //获取最小的顶点
        minVertex.x = min(minVertex.x, XMVectorGetX(Vert));    // 得到模型最小x值
        minVertex.y = min(minVertex.y, XMVectorGetY(Vert));    // 得到模型最小y值
        minVertex.z = min(minVertex.z, XMVectorGetZ(Vert));    // 得到模型最小z值

        //获取最大的顶点
        maxVertex.x = max(maxVertex.x, XMVectorGetX(Vert));    // 得到模型最大x值
        maxVertex.y = max(maxVertex.y, XMVectorGetY(Vert));    // 得到模型最大x值
        maxVertex.z = max(maxVertex.z, XMVectorGetZ(Vert));    // 得到模型最大x值
    }
